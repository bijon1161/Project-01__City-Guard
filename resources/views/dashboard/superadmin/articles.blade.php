...
<body class="">
    ...
    -->
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/superadmin/login">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container p-0">
                    ...
                    <form action="{{ route('nat') }}" method="POST">
                        @csrf
                        <div class="card px-4">
                            <p class="h8 py-3">Articles</p>
                            
                            <div class="row gx-3">
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Person Name</p>
                                        <input class="form-control mb-3" type="text" name="name" value={{Auth::user()->name}}>
                                    </div>
                                </div>
                                <input class="form-control mb-3" type="text" name="price" value='' hidden>
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Designation</p> <input class="form-control mb-3" name="designation" type="text" value={{Auth::user()->designation}}>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Message</p> <input class="form-control mb-3" name="message" type="text" required placeholder="Write Articles Here">
                                    </div>
                                </div>


                                <div class="col-12 ps-3">
                                    <button type="submit" class="btn btn-primary mb-3" name="submit" id="submit">
                                        Submit
                                    </button>
                                </div>
