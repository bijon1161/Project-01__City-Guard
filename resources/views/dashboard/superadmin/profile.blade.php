            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  ...
                  <a class="dropdown-item" href="{{ route('superadmin.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Log out</a>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <form method="POST" class="login100-form validate-form p-b-33 p-t-5" action="{{ route('superadmin.update') }}">
