            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Recharge Request</h4>
                  <p class="card-category"> Here is the list of users who asked for recharge</p>
                </div>
                <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-12 ps-3">
                              <a href="{{ route('admin.rechargecard', $data['id']) }}" class="btn btn-primary mb-3"> Recharge </a>
