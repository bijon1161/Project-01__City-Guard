            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Alert Notifications</h4>
                  <p class="card-category"> List of alert with respective user</p>
                </div>
                <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-12 ps-3">
                              <a href="#" class="btn btn-primary mb-3"> Check Validation</a>
                          ...
                          <div class="col-12 ps-3">
                              ...
                              <a href="{{ route('admin.delete2', $data['id']) }}" class="btn btn-primary mb-3"> Clear </a>
