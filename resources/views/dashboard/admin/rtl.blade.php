...
<head>
  ...
  <!-- CSS Files -->
  <link href="../assets2/css/material-dashboard.min.css?v=2.1.2" rel="stylesheet" />
  <link href="../assets2/css/material-dashboard-rtl.min.css?v=1.1" rel="stylesheet" />
...
<body class="">
  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="/admin/rtl">
    ...
    <script src="../assets2/js/core/bootstrap-material-design.min.js" type="text/javascript"></script>
    ...
    <script src="../assets2/js/material-dashboard.min.js?v=2.1.2" type="text/javascript"></script>
