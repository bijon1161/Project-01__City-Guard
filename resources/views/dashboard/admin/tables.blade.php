            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Local Users</h4>
                  <p class="card-category"> Here is the list of local users</p>
                </div>
                <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-12 ps-3">
                              ...
                              <a href="{{ route('admin.delete', $data['id']) }}" class="btn btn-primary mb-3"> Delete </a>
