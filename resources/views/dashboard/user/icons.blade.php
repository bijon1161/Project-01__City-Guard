      ...
      <div class="content">
        <div class="container p-0">
          ...
          <div>
                    ...
                    <div>
                        @if (Session::get('card_notExists'))
                        <div class="alert alert-danger">
                            {{ Session::get('card_notExists') }}
                        </div>
                        @endif
                    </div>
                    <div>
                        @if (Session::get('wrongcard_no'))
                        <div class="alert alert-danger">
                            {{ Session::get('wrongcard_no') }}
                        </div>
                        @endif
                    </div>
            ...
            <form action="{{ route('user.recharge') }}" method="POST">
              @csrf
              <div class="card px-4">
                <p class="h8 py-3">Recharge Credentials</p>
                <div class="row gx-3">
                  <div class="col-12">
                  ...
                  <input class="form-control mb-3" type="hidden" name="username" value={{Auth::user()->username}}>
                  <div class="col-12">
                    <div class="d-flex flex-column">
                      <p class="text mb-1">Card Number</p> <input class="form-control mb-3" name="card_no" type="text" required placeholder="241 022 6563">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="d-flex flex-column">
                      <p class="text mb-1">Recharge Amount</p> <input class="form-control mb-3" name="amount" type="text" required placeholder="1000">
                    </div>
                  </div>
