                    ...
                    <form action="{{ route('user.pay') }}" method="POST">
                        ...
                        <div class="card px-4">
                            ...
                            <div class="row gx-3">
                                ...
                                <input class="form-control mb-3" type="text" name="price" value="20" hidden>
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <p class="text mb-1">Choose package :</p>
                                        ...
                                        <div class="form-select">
                                            <select name="package" id="package">
                                                ...
                                                <option value="4">Fortnightly(Org)</option>
                                                <option value="5">Monthly(org)</option>
                                                <option value="6">Yearly(org)</option>
                                ...
                                <div class="col-12 ps-3">
                                    <button class="btn btn-primary mb-3"  type="submit" class="btn btn-primary mb-3" name="submit" id="submit">
                                        Pay
                                    </button>
                                </div>
