          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <form method="POST" class="login100-form validate-form p-b-33 p-t-5" action="{{ route('user.update') }}">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" readonly name="national_id" value="{{$data->national_id}}"class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating"></label>
                          <input type="hidden" name="about_us" value="{{$data->about_us}}"class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Date of Birth</label>
                          <input type="text" name="birth_date" value="{{$data->birth_date}}"class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">MY Card</label>
                          <input type="text" name="card_no" value="{{$data2->card_no}}"class="form-control" readonly> 
                          <input type="text" name="balance" value="{{$data2->balance}}"class="form-control" readonly>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../assets2/img/faces/marc.jpg" />
                  </a>
                </div>
                <div class="card-body">
                  ...
                  Trying to achieve a dynamic and bright career in a professional organization where I can use
and enhance my skills, creativity and learning experiences to build useful software that
has business values and to contribute in the welfare of the institution.
                  </p>
                  <a href="https://github.com/bijon1161" target="_blank" class="btn btn-primary btn-round">Follow</a>
                </div>
              </div>
            </div>
          </div>
