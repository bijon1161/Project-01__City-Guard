        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container p-0">
                    ...
                    <form action="{{ route('case') }}" method="POST">
                        @csrf
                        <div class="card px-4">
                            <p class="h8 py-3">Feedbacks</p>
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Email</p> <input class="form-control mb-3" name="email" type="email" value={{Auth::user()->email}}>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Message</p> <input class="form-control mb-3" name="message" type="text" required placeholder="Write Feedback Here">
                                    </div>
                                </div>
