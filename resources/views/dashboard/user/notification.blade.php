        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container p-0">
                    ...
                    <form action="{{ route('user.noti') }}" method="POST">
                        @csrf
                        <div class="card px-4">
                            <p class="h8 py-3">File Complaints</p>
                            <div class="row gx-3">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Email</p> <input class="form-control mb-3" name="email" type="email" required placeholder="something@gmail.com">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        <p class="text mb-1">Message</p> <input class="form-control mb-3" name="message" type="text" required placeholder="Write Complain Here">
                                    </div>
                                </div>
