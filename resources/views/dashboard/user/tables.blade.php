    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container p-0">
          ...
          <form action="{{ route('user.tab') }}" method="POST">
            @csrf
            <div class="card px-4">
              <p class="h8 py-3">Set Alert</p>
              <div class="row gx-3">
                <div class="col-12">
                ...
                <div class="col-12">
                  <div class="d-flex flex-column">
                    <p class="text mb-1">Location</p> <input class="form-control mb-3" name="location" type="text" required placeholder="Write Location Here">
                  </div>
                </div>
