...
<head>
    ...
    <link href="{{asset('admin1')}}/fonts/material-icon/css/material-design-iconic-font.min.css" rel="stylesheet" type="text/css">
    <link href="{{asset('admin1')}}/fonts/material-icon/css/material-design-iconic-font.min.css" rel="stylesheet">
